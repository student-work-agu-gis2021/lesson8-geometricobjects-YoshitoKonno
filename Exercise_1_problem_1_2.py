...
# YOUR ANSWER HERE
def create_point_geom():
    """
    This function create a shapely Point geometry object and return that
    """
def create_line_geom():
    """
    This function takes a list of Shapely Point objects as parameter called points and returns a LineString object of those input points.
    """ 
def create_poly_geom():
    """
    This function　has one parameter called coords. coords parameter should containt a list of coordinate tuples. The function should create and return a Polygon object based on these coordinates.
    """ 
def get_centroid():
    """
    This function has one parameter called geom. The function should take any kind of Shapely's geometric object as an input, and return a centroid of that geometry. 
    """ 
def get_area():
    """
    This function has one parameter called polygon.
    Function should take a Shapely's Polygon object as input and returns the area of that geometry.
    """
def get_length():
    """
    This function has one parameter called geom.
    The function should accept either a Shapely LineString or Polygon object as input. Function should check the type of the input and returns the length of the line if input is LineString and length of the exterior ring if input is Polygon. 
    """
